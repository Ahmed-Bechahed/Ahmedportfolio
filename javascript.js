...
counter(1,10,"line2","val2");
counter(1,60,"line3","val3");
counter(1,50,"line4","val4");
...
send.addEventListener('click',()=>{
  ...
  if (index==0){myquestions.push(`thank you Mr(s) ${clientinfo[0]} .All your informations are saved.`)};
  ...
  if (index==myquestions.length-1){
    document.querySelector('.barchatbox div').innerHTML='Offline';
    document.getElementById('connectcircle').style.color='gray';
    }
    replay(index);
...
/* reveal techicons */
let ico=document.querySelectorAll('.techicons div');
for(let z=0;z<ico.length;z++){
ScrollReveal().reveal(`#tech${z+1}`,{
  reset:true,
  duration: 800,
  origin:'left',
  distance:'100px',
...
/*rveal chatbox*/
ScrollReveal().reveal('.chatcontainer',{
  reset:true,
  duration: 1000,
  origin:'left',
  distance:'200px',
